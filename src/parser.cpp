...
#line 139 "parser.cpp" /* yacc.c:339  */
...
#line 289 "parser.cpp" /* yacc.c:355  */
};
...
#line 320 "parser.cpp" /* yacc.c:358  */
...
{
       0,   199,   199,   222,   237,   241,   247,   252,   259,   263,
     269,   274,   281,   341,   350,   354,   360,   365,   372,   414,
     422,   432,   436,   448,   506,   510,   516,   520,   526,   532,
     538,   544,   552,   561,   568,   575,   582,   589,   599,   606,
     619,   623,   627,   631,   635,   639,   643,   649,   664,   674,
     683,   694,   707,   721,   726,   733,   749,   754,   760,   774,
     849,   860,   866,   881,   885,   891,   896,   903,   907,   913,
     918,   925,   929,   939,   950,   961,   972,   983,   994,  1005,
    1016,  1027,  1038,  1049,  1060,  1070,  1081,  1092,  1101,  1106,
    1115
};
#endif
...
#line 283 "parser.y" /* yacc.c:1646  */
    {
        ...
        if ((yyvsp[-6].node_w_type_list_ptr_list_ptr)!=nullptr)
            for(uint i=0; i<(yyvsp[-6].node_w_type_list_ptr_list_ptr)->size(); i++){
                // put node (Node)
                parameters->push_back((*(yyvsp[-6].node_w_type_list_ptr_list_ptr))[i]->node);
        ...
        if ((yyvsp[-6].node_w_type_list_ptr_list_ptr) != nullptr){
            for(uint i=0; i<(yyvsp[-6].node_w_type_list_ptr_list_ptr)->size(); i++)
            if((*(yyvsp[-6].node_w_type_list_ptr_list_ptr))[i] != nullptr)
                delete (*(yyvsp[-6].node_w_type_list_ptr_list_ptr))[i];
        
            delete (yyvsp[-6].node_w_type_list_ptr_list_ptr);
        }
    }
...
#line 1117 "parser.y" /* yacc.c:1906  */
